...
- Emails transaccionales: actualmente PHPMailer + Gmail SMTP con cuenta danimm3097@digitechfp.com (válido para TFG). IMPORTANTE: esta cuenta es del centro educativo y puede desactivarse al finalizar el grado. En producción real hay dos opciones: (1) migrar a cuenta Gmail personal con App Password, o (2) migrar a Resend, SendGrid o Mailgun con dominio propio noreply@oxphyre.com — opción recomendada para producción real. Gmail tiene límite de ~500 emails/día y muestra la cuenta del remitente, no una dirección de marca.
