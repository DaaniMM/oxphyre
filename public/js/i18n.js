...
const translations = {
  es: {
    ...
    carousel: {
      ...
      tour_hint: 'Click para ver el tour del negocio',
      tag_free: 'Free',
      tag_pro: 'Pro',
      tag_business: 'Business / Gaussian',
      tag_legacy: 'Legacy',
    ...
    pricing: {
      ...
      details_cta_text: '¿Quieres ver límites, funciones y diferencias plan por plan?',
      details_cta_link: 'Ver comparativa completa',
  ...
  en: {
    ...
    carousel: {
      ...
      tour_hint: 'Click to explore the business tour',
      tag_free: 'Free',
      tag_pro: 'Pro',
      tag_business: 'Business / Gaussian',
      tag_legacy: 'Legacy',
    ...
    pricing: {
      ...
      badge_save: 'Save 20%',
      details_cta_text: 'Want to compare limits, features and plan differences?',
      details_cta_link: 'See full comparison',
      free_name: 'Free',     free_price_monthly: '€0',  free_price_annual: '€0',
