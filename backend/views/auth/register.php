...
<!-- Register: formulario izquierda, esfera derecha (row-reverse) -->
<div class="auth-layout auth-layout--mirror">

  <!-- ── Panel esfera ── -->
  <div id="auth-sphere-panel" aria-hidden="true">
  ...
  <div class="auth-form-panel">
    <div class="auth-form-container">
      ...
      <form class="auth-form" action="/registro" method="POST" novalidate id="register-form">
        ...
        <button type="submit" class="btn-auth">Crear cuenta gratis</button>
