...
$routes = [
    'GET' => [
        ...
        '/tour-virtual-para-restaurantes' => ['HomeController', 'showVirtualTourForRestaurants'],
        '/blog' => ['HomeController', 'showBlog'],
        '/blog/como-hacer-fotos-para-tour-virtual' => ['HomeController', 'showBlogPhotosGuide'],
        '/blog/tour-virtual-con-movil-sin-camara-360' => ['HomeController', 'showBlogMobileTour'],
        '/blog/como-usar-qr-para-ensenar-tu-local' => ['HomeController', 'showBlogQrGuide'],
        '/sobre-nosotros' => ['HomeController', 'showAbout'],
        '/soporte' => ['HomeController', 'showSupport'],
        '/contacto' => ['ContactController', 'show'],
        ...
        '/dashboard/analiticas'        => ['DashboardController', 'showAnalytics', 'auth'],
    ...
    'POST' => [
        ...
        '/contacto' => ['ContactController', 'submit'],
